...
*Pre-flight output — before / after:*

```
Before — the slip (echoed the line I typed, never read the state):

You typed: "work on the deck."
Task:  Work on the deck.
Goal:  Finish the deck.
Done:  Deck finished.
```

```
After — the fixed run (reads the project, computes the gap, bounds the action):

Current state:  deck at 7/12 slides; data section blocked on Q3 numbers.
Goal:           deck ready for Thursday's review.
Gap:            5 slides + the data section.
Task (75 min):  draft slides 8–10; stub the data section with placeholders.
Done:           slides 8–10 drafted, data section stubbed.  (Not "deck finished.")
```
...
I've built skills that saved me real time, and skills that quietly did the wrong thing for days before I caught it. In a product team, the instinct to instrument — to check whether the thing is actually working — is everywhere. On your own, building your own skills, I see almost none of it. That's the part I'm actually writing about.
